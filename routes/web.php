...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Useritineraries
    Route::delete('useritineraries/destroy', 'UseritinerariesController@massDestroy')->name('useritineraries.massDestroy');
    Route::resource('useritineraries', 'UseritinerariesController');

    // Financial
    Route::delete('financials/destroy', 'FinancialController@massDestroy')->name('financials.massDestroy');
